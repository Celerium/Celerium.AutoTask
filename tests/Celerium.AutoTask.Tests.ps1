...
.NOTES
    ...
    NAME: Celerium.AutoTask.Tests.ps1
    Type: PowerShell
...
.SYNOPSIS
    Pester tests for the Celerium.AutoTask module manifest file
...
.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-AutoTaskAPIKey.Tests.ps1

    Runs a pester test and outputs simple results

.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-AutoTaskAPIKey.Tests.ps1 -Output Detailed
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'Celerium.AutoTask.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'c2d6db6b-874b-49ec-b9d9-ec5db3f141a9'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Celerium.AutoTask/blob/master/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget) {
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 21 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 22
        }
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Celerium.AutoTask/blob/master/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Celerium.AutoTask'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/Celerium.AutoTask/refs/heads/main/.github/images/PoSHGallery_Celerium.AutoTask.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Celerium.AutoTask/blob/master/README.md'
        }
    ...
    Context "[ $moduleName.psd1 ] module import test" {
        ...
        It "Module contains only PowerShell files" {
            ($moduleFiles | Group-Object Extension).Name.Count | Should -BeLessOrEqual 4
        }
