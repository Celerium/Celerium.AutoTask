#
# Module manifest for module 'Celerium.AutoTask'
#
...
@{
    ...
    RootModule = 'Celerium.AutoTask.psm1'
    ...
    Description = 'This module provides a PowerShell wrapper for the AutoTask API. AutoTask provides a REST Application Programming Interface (API) to enable programmatic access to information and operations available within the AutoTask Web Portal'

    # Copyright information of this module
    Copyright = 'https://github.com/Celerium/Celerium.AutoTask/blob/master/LICENSE'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('AutoTask', 'Kaseya', 'API', 'PowerShell', 'Windows', 'MacOS', 'Linux', 'PSEdition_Desktop', 'PSEdition_Core', 'Celerium')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/Celerium/Celerium.AutoTask/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/Celerium/Celerium.AutoTask'

            # A URL to an icon representing this module.
            IconUri = 'https://raw.githubusercontent.com/Celerium/Celerium.AutoTask/refs/heads/main/.github/images/PoSHGallery_Celerium.AutoTask.png'

            # ReleaseNotes of this module
            ReleaseNotes = 'https://github.com/Celerium/Celerium.AutoTask/blob/master/README.md'
