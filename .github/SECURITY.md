...
The "Celerium.AutoTask" team and community take all security bugs in "Celerium.AutoTask" seriously. Thank you for improving the security of "Celerium.AutoTask". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "Celerium.AutoTask" will confirm the problem and determine the affected versions.
- "Celerium.AutoTask" will audit code to find any potential similar problems.
- "Celerium.AutoTask" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
